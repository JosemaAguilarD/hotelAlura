...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					loginNuevo(txtUsuario.getText(), txtContrasena.getText());
	...
	private void loginNuevo(String usuario, String contrasena) throws SQLException {
		 
		HuespedController huesped = new HuespedController();
		Boolean logeado = huesped.login(usuario, contrasena);
